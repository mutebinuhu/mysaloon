...
const AboutUs = () => {
    ...
    return (
        <div id="about-us" ref={sectionRef} className='md:flex justify-between'>
            <div className='bg-[#1F1F1F] w-full transition-opacity duration-1000 opacity- space-between md:flex py-12'>
                <section className='md:w-1/2 text-white/70 px-4 md:px-8'>
                ...
                <section className='md:w-1/2 mt-12 md:mt-0 flex justify-center items-center px-4 md:px-8'>
